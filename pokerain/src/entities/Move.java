...
public class Move {
    ...
    private int pp;            // points rămase
    private int maxPp;
    private CreatureType type;
    private MoveCategory category;
    private StatusEffect sideEffect; // efect secundar, poate fi NONE

    public Move(String name, int power, int accuracy, int pp,
                CreatureType type, MoveCategory category, StatusEffect sideEffect) {
        this.name       = name;
        this.power      = power;
    ...
    public String toString() {
        return String.format("%-14s | Putere: %3d | Precizie: %3d%% | PP: %d/%d | Tip: %-10s | Categorie: %s",
